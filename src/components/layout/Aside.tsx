		...
		<div className="relative">
			<aside className="fixed left-0 hidden py-2 h-full w-14 flex-col max-h-screen overflow-y-auto overflow-x-hidden bg-muted border-muted border-r md:sticky md:flex lg:w-56 lg:p-3">
				<div className="flex h-full flex-col justify-between">
					...
					<Link to={route.HOME} className="inline-flex justify-center item-center h-[36px] text-center lg:hidden">
				...
				<div>
					...
					<small className="text-default mx-3 mb-2 mt-1 hidden text-[0.5rem] opacity-50 lg:block">
						© 2025{' '}
						<Link to={route.HOME} className="hover:underline" target="_blank">
							ACONTAX, Inc.
						</Link>
					</small>
				</div>
